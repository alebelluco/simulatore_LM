    ...
    for mac in macchine:
        ...
        if name_machine == 'Zeiss':
            ...
            macchina = des.Machine_isola5AM(env,
                                ...
                                k*10, freq_eq, t_eq, 
                                operatore1 ,operatore2,
                                0, list_controlli[0][0], list_controlli[0][1], list_controlli[0][2],list_controlli[0][3],
                                k,list_controlli[1][0], list_controlli[1][1], list_controlli[1][2],list_controlli[1][3],
                                k,list_controlli[2][0], list_controlli[2][1], list_controlli[2][2],list_controlli[2][3],
                                k,list_controlli[3][0], list_controlli[3][1], list_controlli[3][2],list_controlli[3][3],
                                k,list_controlli[4][0], list_controlli[4][1], list_controlli[4][2],list_controlli[4][3],
                                k,list_turno[0][0], list_turno[0][1],list_turno[0][2],
                                k*4, list_turno[1][0], list_turno[1][1],list_turno[1][2],
                                k*4, list_turno[2][0], list_turno[2][1],list_turno[2][2],
                                durata_cor, periodo_cor, op_corr,
                                durata_SAP, periodo_SAP, op_sap,
                                durata_part_in, periodo_part_in, op_in,
                                durata_part_out, periodo_part_out, op_out)
